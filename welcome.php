      ...
      <div class="grid-item">
        <div class="card">
          ...
          <div class="card-content">
            ...
            <p class="card-text">
            Those who are willing to easy their life you can order foods by one clicking. This is the best option because we are providing day to day update and recommended foods will be notified for your easy references.</p>
          </div>
        </div>
      </div>
      <div class="grid-item">
        <div class="card">
          ...
          <div class="card-content">
            ...
            <p class="card-text">
            Malnutrition is a critical problem in now a day. To prevent & control before it become a global disaster is one of our purposes so here are some recommended treatments and medicine by doctors to reduce and control malnutrition. </p>
          </div>
        </div>
      </div>
    </div>
